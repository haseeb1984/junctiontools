...
// Deterministic, side-effect-free contact endpoint fixture.
// It mirrors the public endpoint's important validation boundaries without
// sending email or touching production data.
