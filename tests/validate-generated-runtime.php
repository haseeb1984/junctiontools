...
$specData=['specifications'=>[
 ['spec_status'=>'draft','generation_eligible'=>false,'seo'=>['description'=>'Free age calculator.','title'=>'Age Calculator | Free Online Tool | JunctionTools'],'tool'=>['name'=>'Age Calculator','slug'=>'age-calculator','implementation_template'=>'date-age-calculator'],'inputs'=>['fields'=>[['name'=>'birth_date','type'=>'date'],['name'=>'as_of_date','type'=>'date']]]],
 ['spec_status'=>'draft','generation_eligible'=>false,'seo'=>['description'=>'Free QR code generator.'],'tool'=>['name'=>'QR Code Generator','slug'=>'qr-code-generator','implementation_template'=>'qr-generator'],'inputs'=>['fields'=>[['name'=>'input','type'=>'text']]]]
]];
...
foreach($files as $file){
  ...
  if(preg_match('/<link\b[^>]+rel=["\'][^"\']*stylesheet[^"\']*["\'][^>]+href=["\'](?:https?:|\/\/)/i',$html)){fwrite(STDERR,"External stylesheet resource detected.\n");exit(1);}
